        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        We have proffesionals in all departments that are ready to provide proffesional services and put a smile on your face.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        Our team is ready to provide great support that you deserve.
                    </p>
                </div>
            </div>
...
<section class = "our-brands" id = "brands">
    <div class = "container">
        <div class="section-header">
            <div class="section-title">
                First Class Car Hire Services
            </div>
            <hr class="separator">
            <div class="section-tagline">
                We offer professional car Hire services in our range of high-end vehicles
            </div>
        </div>
				...
				<form method="POST" action = "reserve.php" class = "car-reservation-form" id = "reservation_form" v-on:submit = "checkForm">
					...
					<div>
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "pickup_location" placeholder = "old Town" v-model = 'pickup_location'>
						...
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "return_location" placeholder = "Old Town" v-model = 'return_location'>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        DOMINION<span style = "color:#04DBC0">&nbsp;CAR</span>&nbsp;HIRE
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>Biwi, Lilongwe
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>mdzukulu.mw@gmail.com
                        </li>
                        <li>
                            <i class="fas fa-mobile-alt"></i>+265992272058
                        </li>
                    </ul>
                </div>
            </div>
